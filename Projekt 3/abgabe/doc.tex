...
Unsere Vorgehensweise bei dieser Aufgabe ist wie folgt:
  \begin{itemize}
    \item Wir nehmen ein Beispielbild und suchen die subjektiv $k=10$ ähnlichsten Bilder
    \item Wir zählen relevanten Dokumente (im Bezug auf das Beispielbild)
  ...
  \subsection{Bilder 0 - 99.jpg}
    \begin{itemize}
      ...
      \item Irrelevante: 4, 14, 17, 30, 31, 28, 51, 63, 73, 72, 79, 90
    \end{itemize}
