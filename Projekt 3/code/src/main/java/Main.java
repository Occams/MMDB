...
public class Main {
	...
	public static void main(String[] args) {
		...
		Set<Integer> best = new HashSet<Integer>(getLinkedList(new int[] {594,504,509,513,519,525,532,535,542,545,555,557,559,560,577,582,583,585,587,588,590,591,594,596,597}));
