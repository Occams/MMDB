...
/**
 * Use DocumentBuilderFactory to create a DocumentBuilder, which will create
 * Lucene Documents from images. <br/>
...
public class DocumentBuilderFactory {
	...
	public static DocumentBuilder getDefaultDocumentBuilder() {
		return new GenericFastDocumentBuilder(CEDD.class,
				DocumentBuilder.FIELD_NAME_CEDD);
	}

	/**
	 * Creates a simple version of a DocumentBuilder using the MPEG/-7 visual
	 * features features all available descriptors are used.
	 * 
	...
	/**
	 * Creates a fast (byte[] based) version of the MPEG-7 ColorLayout document
	 * builder.
	 * 
	 * @return the document builder.
	 */
	public static DocumentBuilder getColorLayoutBuilder() {
		return new GenericFastDocumentBuilder(ColorLayout.class,
				DocumentBuilder.FIELD_NAME_COLORLAYOUT);
	}

	/**
	 * Creates a fast (byte[] based) version of the MPEG-7 EdgeHistogram
	 * document builder.
	 * 
	 * @return the document builder.
	 */
	...
	public static DocumentBuilder getScalableColorBuilder() {
		return new GenericFastDocumentBuilder(ScalableColor.class,
	 ...
	 * @return a fully featured DocumentBuilder.
	 * @see net.semanticmetadata.lire.imageanalysis.ScalableColor
	 * @deprecated Use ColorHistogram and the respective factory methods to get
	 *             it instead
	 */
	...
	/**
	 * Creates a simple version of a DocumentBuilder using the ColorLayout
	 * feature. Don't use this method any more but use the respective feature
	 * bound method instead.
	 * 
	 * @return a simple and fast DocumentBuilder.
	 * @see net.semanticmetadata.lire.imageanalysis.ColorLayout
	 * @deprecated use MPEG-7 feature ColorLayout or CEDD, which are both really
	 *             fast.
	 */
	...
	/**
	 * Creates a DocumentBuilder for the AutoColorCorrelation feature. Note that
	 * the extraction of this feature is especially slow! So use it only on
	 * small images! Images that do not fit in a 200x200 pixel box are resized
	 * by the document builder to ensure shorter processing time. See
	 * {@link net.semanticmetadata.lire.imageanalysis.AutoColorCorrelogram} for
	 * more information on the image feature. Be sure to use the same options
	 * for the ImageSearcher as you used for the DocumentBuilder.
	 * 
	...
	public static DocumentBuilder getAutoColorCorrelogramDocumentBuilder() {
		return new GenericDocumentBuilder(AutoColorCorrelogram.class,
				DocumentBuilder.FIELD_NAME_AUTOCOLORCORRELOGRAM,
				GenericDocumentBuilder.Mode.Fast);
	}

	/**
	 * Creates a DocumentBuilder for the AutoColorCorrelation feature. Note that
	 * the extraction of this feature is especially slow, but this is a more
	 * fast, but less accurate settings version! Images that do not fit in a
	 * defined bounding box they are resized by the document builder to ensure
	 * shorter processing time. See
	 * {@link net.semanticmetadata.lire.imageanalysis.AutoColorCorrelogram} for
	 * more information on the image feature. Be sure to use the same options
	 * for the ImageSearcher as you used for the DocumentBuilder.
	 * 
	...
	public static DocumentBuilder getFastAutoColorCorrelationDocumentBuilder() {
		return new CorrelogramDocumentBuilder(
				AutoColorCorrelogram.Mode.SuperFast);
	}

	/**
	 * Creates a DocumentBuilder for the CEDD feature. See
	 * {@link net.semanticmetadata.lire.imageanalysis.CEDD} for more information
	 * on the image feature. Be sure to use the same options for the
	 * ImageSearcher as you used for the DocumentBuilder.
	 * 
	 ...
	 * {@link net.semanticmetadata.lire.imageanalysis.FCTH} for more information
	 * on the image feature. Be sure to use the same options for the
	 * ImageSearcher as you used for the DocumentBuilder.
	 * 
	...
	public static DocumentBuilder getFCTHDocumentBuilder() {
		return new GenericDocumentBuilder(FCTH.class,
	 ...
	 * {@link net.semanticmetadata.lire.imageanalysis.JCD} for more information
	 * on the image feature. Be sure to use the same options for the
	 * ImageSearcher as you used for the DocumentBuilder.
	 * 
	...
	public static DocumentBuilder getJCDDocumentBuilder() {
		return new GenericFastDocumentBuilder(JCD.class,
				DocumentBuilder.FIELD_NAME_JCD);
	}

	/**
	 * Creates a DocumentBuilder for the JpegCoefficientHistogram feature. See
	 * {@link net.semanticmetadata.lire.imageanalysis.JpegCoefficientHistogram}
	 * for more information on the image feature. Be sure to use the same
	...
	public static DocumentBuilder getJpegCoefficientHistogramDocumentBuilder() {
		return new GenericDocumentBuilder(JpegCoefficientHistogram.class,
	 ...
	 * {@link net.semanticmetadata.lire.imageanalysis.SimpleColorHistogram} for
	 * more information on the image feature. Be sure to use the same options
	 * for the ImageSearcher as you used for the DocumentBuilder.
	 * 
	...
	public static DocumentBuilder getColorHistogramDocumentBuilder() {
		return new GenericDocumentBuilder(SimpleColorHistogram.class,
	 ...
	 * information on the image feature. Be sure to use the same options for the
	 * ImageSearcher as you used for the DocumentBuilder.
	 * 
	 * @return the created Tamura feature DocumentBuilder.
	 */
	public static DocumentBuilder getTamuraDocumentBuilder() {
		return new GenericFastDocumentBuilder(Tamura.class,
	...
	public static DocumentBuilder getGaborDocumentBuilder() {
		return new GenericFastDocumentBuilder(Gabor.class,
				DocumentBuilder.FIELD_NAME_GABOR);
	}

	/**
	 * Creates and returns a DocumentBuilder, which contains all available
	 * features. For AutoColorCorrelogram the
	 * getAutoColorCorrelogramDocumentBuilder() is used. Therefore it is
