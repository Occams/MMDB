...
\mysection{Aufgabe 1: Bildeditor}
\textit{Analysieren Sie den Aufbau und die Arbeitsweise des Bildeditors. Das Gerüst der Anwendung steht Ihnen in der Archivdatei Bildeditor.jar auf der Homepage der Lehrveranstaltung zur
Verfügung. Das Programm benötigt eine Java-Installation (http://www.java.com/de/download/manual.jsp).
}
